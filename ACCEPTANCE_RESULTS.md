...
**Historical candidate report:** the 11 September update adds a shared website password, a price catalogue and further usability fixes. Its current execution evidence is in [password and branch verification](docs/PASSWORD_BRANCH_VERIFICATION_2026-09-11.md). Earlier statements below about no password feature or missing Flask dependencies describe the earlier candidate.
